...
@section('content')
    ...
    <div class="container-fluid" style="background-image: linear-gradient(#0086a6,#002836); background-size: cover; min-height: 100vh;">
        ...
        <main role="main">
            ...
            <!-- new-->
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Modal Form </button>
            <!-- Modal -->
            <div class="modal fade" id="staticBackdrop" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <form id="AddEditForm" action="/Report/AddDriver" method="post" style="
">
                        <input name="__RequestVerificationToken" type="hidden" value="CfDJ8MpeFotPAMFNlNdhtnT-lqDy14CeYnq5nVcL4WjspiNeCMFYTryhsRlc6irXTTiPDOm5VvcJHLxiOjjzbmXQVEQKJXQCPotcfAe7zU1FnSv-bURvasffkmQuyybskpxaPbKjwCf-2SFdz1Zm2cHHBjI">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 col-xl-4 float-start pb-2">
                                        <input type="date" id="DateOfBirth" name="DateOfBirth" class="form-control" min="1924-08-30" max="2024-08-30">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 col-xl-4 float-start pb-2">
                                        ...
                                        </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-1-48n2" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-VehicleModelID-container" aria-controls="select2-VehicleModelID-container"><span class="select2-selection__rendered" id="select2-VehicleModelID-container" role="textbox" aria-readonly="true"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    </div>
                                    <div class="col-12 col-lg-2 col-xl-2 float-start pb-2 fw-bold">
                                        Colour
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 col-xl-4 float-start pb-2">
                                        <input id="PolicyExpiryDate" name="PolicyExpiryDate" type="date" min="2023-08-30" max="2034-08-30" class="form-control">
                                    </div>
                                </div>
                            </div>
